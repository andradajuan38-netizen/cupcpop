// HOSPITAL COMMAND NETWORK - DATOS PARA SIMULACIÓN
// Versión independiente de datos de hospitales para el módulo de simulación
// Aislado para evitar conflictos con otros módulos

// Alias para compatibilidad con otros módulos
var hospitalNetwork = null;

const hospitalNetworkSimulation = {
    version: "1.0",
...
function getHospitalByIdSimulation(id) {
    if (!id || typeof hospitalNetworkSimulation === 'undefined' || !hospitalNetworkSimulation.hospitals) {
        return null;
    }

    return hospitalNetworkSimulation.hospitals.find(function(hospital) {
        return hospital.id === id;
    }) || null;
}

// Establecer alias después de definir el objeto
hospitalNetwork = hospitalNetworkSimulation;

// Funciones de compatibilidad
function getHospitalById(id) {
    return getHospitalByIdSimulation(id);
}
